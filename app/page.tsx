    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[600px] flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">Your AI Travel Planner</h1>
          <p className="text-xl text-white/90 mb-8">Plan your perfect trip in seconds. Powered by AI, personalized for you.</p>
