        ...
        <div className="px-4 py-3 mx-3 mt-4 bg-gradient-to-r from-violet-50 to-pink-50 rounded-2xl border border-violet-100">
          <div className="flex items-center gap-3">
            ...
            <div className="overflow-hidden">
              <p className="font-semibold text-[#0f172a] text-sm truncate">{user?.firstName || "Traveler"}</p>
              <p className="text-xs text-[#64748b] truncate">{user?.primaryEmailAddress?.emailAddress || ""}</p>
            </div>
          </div>
        </div>
